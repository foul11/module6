...
$(function(){
	...
	/*
		...
		нейронки крутую тянку прикрепить.
		доделаваю дизайн сайта.
		супер генетика сделать кнопку для копирования (как вариант при на ведении на текст делать рамку, и при клике на нее копировать)
